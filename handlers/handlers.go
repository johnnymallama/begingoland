...
import (
	...
	"github.com/johnnymallama/begingoland/middlew"
...
func Manejadores() {
	...
	router.HandleFunc("/eliminarTweet", middlew.ChequeoBD(middlew.ValidoJWT(routers.BorroTweet))).Methods("DELETE")
	...
	router.HandleFunc("/leoTweetSeguidor", middlew.ChequeoBD(middlew.ValidoJWT(routers.LeoTweetSeguidor))).Methods("GET")
